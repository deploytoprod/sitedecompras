...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('southtut2_user', 'password_salt', self.gf('django.db.models.fields.CharField')(max_length=8, null=True), keep_default=False)

        # Adding field 'User.password_hash'
        db.add_column('southtut2_user', 'password_hash', self.gf('django.db.models.fields.CharField')(max_length=40, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.password_salt'
        db.delete_column('southtut2_user', 'password_salt')

        # Deleting field 'User.password_hash'
        db.delete_column('southtut2_user', 'password_hash')
